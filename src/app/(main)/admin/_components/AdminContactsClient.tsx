            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="relative">
                  ...
                  <div className="relative h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <MessageSquare className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 text-blue-foreground" />
                  </div>
                </div>
                ...
                <CardTitle className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <Badge className="bg-blue-500/10 text-blue-500 border-blue-500/20 text-xs">
                      {totalContacts}{" "}
                      {totalContacts === 1 ? "message" : "messages"}
                    </Badge>
                  </div>
                </CardTitle>
                  ...
                  {contacts.map((contact: Contact) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        ...
                        {/* Dropdown Menu - Positioned outside the flex container on mobile */}
